...
$viewState->set('profile-form-social-website',$userData['socials_website']);
$viewState->set('profile-form-social-reddit',$userData['socials_reddit']);
$viewState->set('profile-form-social-twitter',$userData['socials_twitter']);
$viewState->set('profile-form-social-instagram',$userData['socials_instagram']);
$viewState->set('profile-form-social-discord',$userData['socials_discord']);